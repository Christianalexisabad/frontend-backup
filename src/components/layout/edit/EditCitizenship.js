...
import "./Style.css";
import { EDIT_CITIZENSHIP } from "../../../utility/Route";

const EditCitizenship = () => {

    const display = pathContains(EDIT_CITIZENSHIP);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/citizenships/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/citizenships/update/" + id + "/", {
                    name: name
                }).then(res => {  
