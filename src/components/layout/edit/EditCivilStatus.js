...
import "./Style.css";
import { EDIT_CIVIL_STATUS } from "../../../utility/Route";

const EditCivilStatus = () => {

    const display = pathContains(EDIT_CIVIL_STATUS);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/civil-statuses/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/civil-statuses/update/" + id + "/", {
                    name: name
                }).then(res => {  
