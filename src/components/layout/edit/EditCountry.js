...
import "./Style.css";
import { EDIT_COUNTRY } from "../../../utility/Route";

const EditCountry = () => {

    const display = pathContains(EDIT_COUNTRY);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/countries/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/countries/update/" + id + "/", {
                    name: name
                }).then(res => {  
