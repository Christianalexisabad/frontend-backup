...
import "./Style.css";
import { EDIT_PROVINCE } from "../../../utility/Route";

const EditProvince = () => {

    const display = pathContains(EDIT_PROVINCE);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/provinces/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/provinces/update/" + id + "/", {
                    name: name
                }).then(res => {  
