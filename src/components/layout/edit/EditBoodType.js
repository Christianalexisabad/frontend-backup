...
import "./Style.css";
import { EDIT_BLOOD_TYPE } from "../../../utility/Route";

const EditBloodType = () => {

    const display = pathContains(EDIT_BLOOD_TYPE);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/blood-types/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/blood-types/update/" + id + "/", {
                    name: name
                }).then(res => {  
