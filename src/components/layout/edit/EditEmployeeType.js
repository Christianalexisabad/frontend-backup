...
import "./Style.css";
import { EDIT_EMPLOYEE_TYPE } from "../../../utility/Route";

const EditEmployeeType = () => {

    const display = pathContains(EDIT_EMPLOYEE_TYPE);
    const { id } = useParams();
    ...
    const fetchData = async () => {
        const response = await axios.get(getHost() + "/api/employee-types/get/"+ id + "/");
    ...
    const handleSubmit = (e) => { 
        ...
        if (isSuccess) {
            ...
            if (!name) {
                ...
                axios.patch(getHost() + "/api/employee-types/update/" + id + "/", {
                    name: name
                }).then(res => {  
