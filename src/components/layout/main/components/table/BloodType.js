...
import "./Table.css";
import { ADD_BLOOD_TYPE, EDIT_BLOOD_TYPE } from "../../../../../utility/Route";

export default function BloodType(props) {

    const endpoint = getHost() + "/api/blood-types/";
                    ...
                    return (
                        <tr key={id}>
                            ...
                            <td className="text-center">
                                <EditButton to={EDIT_BLOOD_TYPE + id +"/"} />
                            </td>
                        </tr>
                    )
