import { ADD_CIVIL_STATUS, EDIT_CIVIL_STATUS } from "../../../../../utility/Route";
...
export default function CivilStatus(props) {

    const display = true;
    const endpoint = getHost() + "/api/civil-statuses/";
                ...
                <div className="row">
                    <div className="col-left col-lg-6">
                        ...
                        <CustomLink 
                            ...
                            // permission="can_add_civil_status"
                            to={ADD_CIVIL_STATUS}
                        />
                        <Button 
                            type="button"
                    ...
                    return (
                        <tr key={id}>
                            ...
                            <td className="text-center">
                                <EditButton to={EDIT_CIVIL_STATUS + id +"/"} />
                            </td>
                        </tr>
                    )
