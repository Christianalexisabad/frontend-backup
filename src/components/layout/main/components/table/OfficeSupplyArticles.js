...
export default function OfficeSupplyArticles(props) {
    
    const display = true;
    const endpoint = getHost() + "/api/office-supply-articles/";
            ...
            <div className="header">
                <div className="row">
                        <div className="col-left col-lg-6">
                            <Title  
                                text="Office Supply Articles"
                            />
                            <CustomLink 
                                text="Add New Article"
                                to={ADD_OFFICE_SUPPLY_ARTICLE}
                            />
                            <Button 
                                type="button"
                                icon="fa fa-refresh"
                    ...
                    return (
                        <tr key={index}>
                            ...
                            <td className="text-center">
                                <EditButton 
                                    to={"/pages/settings/office supply articles/edit/" + id + "/"}
                                />
                            </td>
                        </tr>
                    )
