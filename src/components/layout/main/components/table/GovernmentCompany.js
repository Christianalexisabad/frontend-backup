...
import "./Table.css";
import { ADD_GOVERNMENT_COMPANY, EDIT_GOVERNMENT_COMPANY } from "../../../../../utility/Route";
import TableFooter from "./components/TableFooter";

export default function GovernmentCompany(props) {

    const display = true;
    const endpoint = getHost() + "/api/government-companies/";
            ...
            <div className="header">
                <div className="row">
                        <div className="col-left col-lg-6">
                            <Title  
                                text="Company/Benefit"
                            />
                            <CustomLink 
                                text="Add New"
                                to={ADD_GOVERNMENT_COMPANY}
                            />
                            <Button 
                                type="button"
                                icon="fa fa-refresh"
                    ...
                    return (
                        <tr key={index}>
                            ...
                            <td className="text-center">
                                <EditButton to={EDIT_GOVERNMENT_COMPANY + item.id +"/"} />
                            </td>
                        </tr>
                    )
