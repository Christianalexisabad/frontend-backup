...
export default function OfficeSupplyTransfer(props) {

    const display = true;
    const endpoint = getHost() + "/api/office-supply-transfers/"
    ...
    function renderTableHeader() {
        ...
        const header = [
            { id: "id", value: "no" },
            { id: "stock", value: "Stock ID" },
            { id: "method", value: "Transfer Method" },
            { id: "status", value: "Transer Status" },
            { id: "recieved_by", value: "Recieved By" },
        ]
        return (
            <thead> 
                <tr>
        ...
        return (
            <tbody>
                { data.length > 0 ? data.map((item, index) => {
                    ...
                    <td><p className="loading">No data to show</p></td>
                </tr> }
            </tbody> 
        )
    }
