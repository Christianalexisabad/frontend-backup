...
import "./Table.css";
import { ADD_CITIZENSHIP, EDIT_CITIZENSHIP } from "../../../../../utility/Route";
import TableFooter from "./components/TableFooter";

export default function Citizenship() {

    const display = true;
    const endpoint = getHost() + "/api/citizenships/";
                ...
                <div className="row">
                    <div className="col-left col-lg-6">
                        ...
                        <CustomLink 
                            ...
                            // permission="can_add_citizenship"
                            to={ADD_CITIZENSHIP}
                        />
                        <Button 
                            type="button"
                    ...
                    return (
                        <tr key={id}>
                            ...
                            <td className="text-center">
                                <EditButton to={EDIT_CITIZENSHIP + id +"/"} />
                            </td>
                        </tr>
                    )
