...
import { CREATE_USER_GROUP, EDIT_USER_GROUP } from "../../../../../utility/Route";
import TableFooter from "./components/TableFooter";

export default function UserGroup() {
    
    const endpoint = getHost() + "/api/user-groups/";
                ...
                <div className="row">
                        <div className="col-left col-lg-6">
                            <CustomLink 
                                ...
                                permission="can_create_user_group"
                                to={CREATE_USER_GROUP}
                            />
                            <Button 
                                type="button"
                                icon="fa fa-refresh"
                    ...
                    return (
                        <tr key={id}>
                            ...
                            <td className="text-center">
                                <EditButton  to={EDIT_USER_GROUP + id +"/"} />
                                <DeleteButton from="user-groups" id={id}  name={group.name} />
                            </td>
                            {/* {
                                (canEdit || canDelete) &&
