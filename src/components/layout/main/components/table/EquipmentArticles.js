...
export default function EquipmentArticles(props) {
    
    const display = true;
    const endpoint = getHost() + "/api/equipment-articles/";
                    ...
                    return (
                        <tr key={index}>
                            ...
                            <td className="text-center">
                                <EditButton 
                                    to={"/pages/settings/equipment articles/edit/" + id + "/"}
                                />
                            </td>
                        </tr>
                    )
