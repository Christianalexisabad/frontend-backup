...
import "./Style.css";
import { ADD_GOVERNMENT_COMPANY } from "../../../utility/Route";

const AddGovernmentCompany = (props) => {
    ...
    const handleSubmit = (e) => { 
        e.preventDefault();  
            ...
            if (!name) {
                ...
                axios.post(getHost() + "/api/government-companies/new/", {
                    name: name
                }).then(res => {  
...
export default AddGovernmentCompany;